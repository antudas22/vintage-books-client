...
const AdvertiseCard = ({advertise, setBooking}) => {
    const {
        name,
        img,
        location,
    ...
    return (
      ...
      <div className="card min-h-[780px] bg-base-100 shadow-2xl">
        ...
        <div className="card-body items-center text-center">
          ...
          <label onClick={() => setBooking(advertise)} htmlFor="booknow-modal" className="btn bg-gradient-to-r from-cyan-500 to-blue-500 border-0 w-full">Book Now</label>
          </div>
        </div>
      </div>
    </div>
